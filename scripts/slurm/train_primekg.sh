#!/bin/bash
#SBATCH --job-name=mva_primekg
#SBATCH --output=/mnt/scratch/kcwp264/mva-hackathon-2026/logs/primekg_%j.out
#SBATCH --error=/mnt/scratch/kcwp264/mva-hackathon-2026/logs/primekg_%j.err
